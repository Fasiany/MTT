    ...
    def slice(self, waveform):
        ...
        for i, rms in enumerate(rms_list):
            ...
            if i - silence_start <= self.max_sil_kept:
                pos = rms_list[silence_start: i + 1].argmin() + silence_start # pos 是右边界
                if silence_start == 0:
        ...
        if len(sil_tags) == 0:
            ...
            if sil_tags[-1][1] < total_frames:
                chunks.append((self._apply_slice(waveform, sil_tags[-1][1], total_frames), (sil_tags[-1][1]*10, total_frames*10)))
                # print(f"Export chunks:{sil_tags[-1][1]} {total_frames}")
            return chunks
