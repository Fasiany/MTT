...
style_kaf_dia = Style(name='Kaf', fontname='Arial', fontsize=28.0, primary_color=Color(r=0xff, g=0x9c, b=0xca, a=0x00),
                      secondary_color=Color(r=0xff, g=0xc0, b=0xcb, a=0x00),
                      outline_color=Color(r=0x00, g=0x00, b=0x00, a=0x00),
                      back_color=Color(r=0x00, g=0x00, b=0x00, a=0x00), bold=False, italic=False, underline=False,
...
style_lyric = Style(name='Lyric', fontname='Arial', fontsize=28.0, primary_color=Color(r=0x0, g=245, b=255, a=0x00),
                    secondary_color=Color(r=0x57, g=0xfa, b=0xff, a=0x00),
                    outline_color=Color(r=0x00, g=0x00, b=0x00, a=0x00),
                    back_color=Color(r=0x00, g=0x00, b=0x00, a=0x00), bold=False, italic=False, underline=False,
...
style_secondary_lyric = Style(name='Note', fontname='Arial', fontsize=23.0,
                              primary_color=Color(r=0x00, g=0xff, b=0x00, a=0x00),
                              secondary_color=Color(r=0x57, g=0xfa, b=0xff, a=0x00),
                              outline_color=Color(r=0x00, g=0x00, b=0x00, a=0x00),
                              back_color=Color(r=0x00, g=0x00, b=0x00, a=0x00), bold=False, italic=False,
                              underline=False,
                              strike_out=False, scale_x=100.0, scale_y=100.0, spacing=0.0, angle=0.0, border_style=1,
                              outline=4.0,
                              shadow=0.0, alignment=2, margin_l=10, margin_r=10, margin_v=25, encoding=134)
